        ...
        @forelse($cartItems as $item)
            <div class="card mb-3 shadow-sm">
                <div class="row g-0 align-items-center">
                    <div class="col-md-2">
                        <img src="{{url('admin/img/Product/' . $item->product_image)}}" class="img-fluid rounded-start"
                    ...
                    <div class="col-md-3 text-end pe-3">
                        ...
                        <a href="{{url('/Order/'.$item->pro_id)}}?qty={{ $item->c_qty }}&id={{$item->id}}" name="buynow" class="btn btn-outline-primary btn-sm">Buy Now</a>
