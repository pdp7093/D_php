                ...
                <div class="col-xl-7 col-md-6">
                    <div class="about_info">
                        ...
                        <p>Esteem spirit temper too say adieus who direct esteem. It esteems luckily or picture placing
                            drawing. Apartments frequently or motionless on reasonable projecting expression enim ad minim
                            veniam quis nostrud exercitation we have supported programmes to help alleviate human suffering
            ...
            <div class="row align-items-center justify-content-center mb-20">
                @foreach ($data as $d)
                    ...
                    <div class="col-xl-10">
                        <div class="row align-items-center">
                            <div class="col-xl-9 col-md-9">
                                <div class="music_field">
                                    <div class="thumb">
                                        <img src="{{url('admin/song_images/' . $d->song_image)}}" alt="" width="100rm">
                                    </div>
                                    <div class="audio_name">
                                        ...
                                        <audio preload="auto" controls>
                                            <source src="{{ asset($d->file_path) }}" type="audio/mpeg">
                                        </audio>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="music_btn">
                            <a href="{{url('/Review/'.$d->id)}}" class="boxed-btn">Review</a>
                        </div>
                    </div>
                        </div>
                    </div>
